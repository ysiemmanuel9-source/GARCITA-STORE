...
6. Para que los codigos de verificacion y comprobantes lleguen por correo real, agrega tambien:
   `ADMIN_RECEIPT_EMAIL=mg4563690@gmail.com`, `SMTP_HOST`, `SMTP_PORT`, `SMTP_USER`, `SMTP_PASSWORD` y `SMTP_FROM`.
